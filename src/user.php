  ...
  <span onclick="document.getElementById('id03').style.display='none'" class="close1" title="Close Cart">&times;</span>
    ...
    echo "<div class='mybook_img1'> <img class='cart_image' src='$temp5' height='100%px' width='100%' style='float:left;'>
	                                  <div class='i1' >
	                                     ...
	                                     </div><div class='cart_button'><form action='buy.php' method='post'>
...
<div class="mybook">
<div class="top_sell"><div class="abc12"><p class="title">My Books<form  action="view_index1.php" method="post"><button name="mybook" class="views2">View All</button></form></p></div> 

<!--<button onclick="document.getElementById('id02').style.display='block'" class="button4"><img src="plus.png" height="100px" width="100px" ></button>-->
<?php

	
	if($con){
	
	 $query="SELECT * FROM `book_user` NATURAL JOIN book WHERE  uname='$temp' ";
	$run=mysqli_query($con,$query);
	 if (mysqli_num_rows($run) > 0) {
	...
	$count=0;
	?>
<img class="best_img" onclick="document.getElementById('id02').style.display='block'" src="plus.png" height="180px" width="150px" style="float:left; 
margin-left:80px;margin-top:40px;">
    ...
    echo "<div class='mybook_img' style='float:left;'>
	                            <img class='best_img' src='$temp5' height='100%px' width='100%' style='float:left;'>
										...
										<input type='hidden' name='uname' value='$temp'>
										<input type='hidden' name='price' value='$temp31'>
										<input type='hidden' name='aname' value='$temp33'>
										<input type='hidden' name='type' value='$temp32'>
	                       <button class='detail_button' name='del' type='submit'>REMOVE</button>
	...
	<button class='detail_button' name='mybook12'>INFORMATION</button></form>
	</div>
		 	...
		 	$count=0;
			?>
<img class="best_img" onclick="
document.getElementById('id02').style.display='block'" src="plus.png" height="180px" width="150px" 
style="margin-left:580px; margin-top:40px;">
<?php
    echo "
	
	
	
	<div style='margin-left:570px; margin-top:50px;'>Oops Book Not Available</div>";
}
	}
	else{
		echo "not connected";
...
<div class="mybook">
<div class="top_sell"><div class="abc12"><p class="title">Current bestsellers <form  action="view_index1.php" method="post"><button name="bestsell" class="views2">View All</button></form></p></div> 

<?php
$con=mysqli_connect('localhost','root','','project');
	
	if($con){
	 $query="SELECT * FROM `cart` NATURAL JOIN `book` where oname!='$temp' ";
	$run=mysqli_query($con,$query);
	 if (mysqli_num_rows($run) > 0) {
    ...
    echo "<div style='margin-left:570px; margin-top:150px;'>Oops Book Not Available</div>";
}
	}
	else{
		echo "not connected";
...
<div class="mybook1">
<div class="abc12"><div><p class="title">Offers<form action="view_index1.php" method="post">
    ...
    echo "<div class='mybook_img'>
	                              <img class='best_img' src='$temp5' height='100%px' width='100%' 
                                       ...
                                       <input type='hidden' name='uname' value='$temp'>
										...
										<button type='submit'  class='detail_button' >ADD TO CART</button>
										</form>
										     <form action='login_detail.php' method='post'>
