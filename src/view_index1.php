    ...
    echo "<div class='mybook_img' style='margin-bottom:120px;'>
	                              <img class='best_img' src='$temp5' height='100%px' width='100%' >
                                       ...
                                       <input type='hidden' name='uname' value='$temp'>
										...
										<button type='submit'  class='detail_button' >BUY</button></form>
							      ...
							      <form action='detail.php' method='post'>
									   ...
									   <input type='hidden' name='oname' value='$temp23'>
											 <button name='mybook12' type='submit' name='detail' class='detail_button' style='margin-bottom:50px;' >DETAIlS</button>
									</form>
...
{
	echo '<div class="mybook1_view" height="500px">
<div class="top_sell"><div class="abc12"><p class="title">My Book <form  action="view_index1.php" method="post"><button name="mybook" class="views2">View All</button></form></p></div>';
		if($con){
    ...
    echo "<div class='mybook_img' style='margin-bottom:120px;'>
	                       ...
	                       <button class='detail_button' name='del' type='submit'>REMOVE</button>
							      ...
							      <form action='detail.php' method='post'>
									   ...
									   <input type='hidden' name='oname' value='$temp'>
											 <button name='mybook12'  type='submit' name='detail' class='detail_button' style='margin-bottom:50px;' >DETAIlS</button>
									</form>
 ...
 <form action='addcart.php' method='post'>
                                       ...
                                       <input type='hidden' name='uname' value='$temp'>
										...
										<button type='submit'  class='detail_button' >BUY</button></form>
										     ...
										     <form action='sdetail.php' method='post'>
									    ...
									    <input type='hidden' name='oname' value='$temp23'>
											 <button name='mybook12' type='submit' name='detail'class='detail_button' >DETAIlS</button></form>
