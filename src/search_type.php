...
<button onclick="document.getElementById('id02').style.display='block'" class="button_top2"style="width:auto;"><p class="button_font"><b>SIGN IN<i class="far fa-user" style="margin-left:5px;"></i></b></a></button>
</div>
<div class="menu">
<div class="menu_bar">
<ul>
...
if($con){
	 $query="SELECT * FROM `book` NATURAL JOIN `book_user` WHERE    type='$temp56' ";
